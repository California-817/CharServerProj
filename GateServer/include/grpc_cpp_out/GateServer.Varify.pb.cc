...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_GateServer_2eVarify_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_GateServer_2eVarify_2eproto = nullptr;
const ::uint32_t
    TableStruct_GateServer_2eVarify_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::GateServer::Varify::GetVarifyReq, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::GateServer::Varify::GetVarifyReq, _impl_.email_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::GateServer::Varify::GetVarifyRsp, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::GateServer::Varify::GetVarifyRsp, _impl_.error_),
        PROTOBUF_FIELD_OFFSET(::GateServer::Varify::GetVarifyRsp, _impl_.email_),
        PROTOBUF_FIELD_OFFSET(::GateServer::Varify::GetVarifyRsp, _impl_.code_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::GateServer::Varify::GetVarifyReq)},
        {9, -1, -1, sizeof(::GateServer::Varify::GetVarifyRsp)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::GateServer::Varify::_GetVarifyReq_default_instance_._instance,
    &::GateServer::Varify::_GetVarifyRsp_default_instance_._instance,
};
const char descriptor_table_protodef_GateServer_2eVarify_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\027GateServer.Varify.proto\022\021GateServer.Va"
    "rify\"\035\n\014GetVarifyReq\022\r\n\005email\030\001 \001(\t\":\n\014G"
    "etVarifyRsp\022\r\n\005error\030\001 \001(\005\022\r\n\005email\030\002 \001("
    "\t\022\014\n\004code\030\003 \001(\t2c\n\014VarifyServer\022S\n\rGetVa"
    "rifyCode\022\037.GateServer.Varify.GetVarifyRe"
    "q\032\037.GateServer.Varify.GetVarifyRsp\"\000b\006pr"
    "oto3"
};
static ::absl::once_flag descriptor_table_GateServer_2eVarify_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_GateServer_2eVarify_2eproto = {
    false,
    false,
    244,
    descriptor_table_protodef_GateServer_2eVarify_2eproto,
    "GateServer.Varify.proto",
    &descriptor_table_GateServer_2eVarify_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_GateServer_2eVarify_2eproto::offsets,
    file_level_enum_descriptors_GateServer_2eVarify_2eproto,
    file_level_service_descriptors_GateServer_2eVarify_2eproto,
};
namespace GateServer {
namespace Varify {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:GateServer.Varify.GetVarifyReq)
}
inline PROTOBUF_NDEBUG_INLINE GetVarifyReq::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::GateServer::Varify::GetVarifyReq& from_msg)
...
GetVarifyReq::GetVarifyReq(
  ...
  // @@protoc_insertion_point(copy_constructor:GateServer.Varify.GetVarifyReq)
}
inline PROTOBUF_NDEBUG_INLINE GetVarifyReq::Impl_::Impl_(
...
GetVarifyReq::~GetVarifyReq() {
  // @@protoc_insertion_point(destructor:GateServer.Varify.GetVarifyReq)
  SharedDtor(*this);
}
...
const ::google::protobuf::internal::ClassDataFull GetVarifyReq::_class_data_ = {
    ...
    &descriptor_table_GateServer_2eVarify_2eproto,
    nullptr,  // tracker
};
...
const ::_pbi::TcParseTable<0, 1, 0, 44, 2> GetVarifyReq::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GetTable<::GateServer::Varify::GetVarifyReq>(),  // to_prefetch
  ...
  {{
    "\36\5\0\0\0\0\0\0"
    "GateServer.Varify.GetVarifyReq"
    "email"
  }},
};

PROTOBUF_NOINLINE void GetVarifyReq::Clear() {
// @@protoc_insertion_point(message_clear_start:GateServer.Varify.GetVarifyReq)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* GetVarifyReq::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:GateServer.Varify.GetVarifyReq)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_email().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "GateServer.Varify.GetVarifyReq.email");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:GateServer.Varify.GetVarifyReq)
          return target;
        }
        ...
        ::size_t GetVarifyReq::ByteSizeLong() const {
          const GetVarifyReq& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:GateServer.Varify.GetVarifyReq)
          ::size_t total_size = 0;
...
void GetVarifyReq::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:GateServer.Varify.GetVarifyReq)
...
// @@protoc_insertion_point(class_specific_copy_from_start:GateServer.Varify.GetVarifyReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:GateServer.Varify.GetVarifyRsp)
}
inline PROTOBUF_NDEBUG_INLINE GetVarifyRsp::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::GateServer::Varify::GetVarifyRsp& from_msg)
      : email_(arena, from.email_),
...
GetVarifyRsp::GetVarifyRsp(
  ...
  // @@protoc_insertion_point(copy_constructor:GateServer.Varify.GetVarifyRsp)
}
inline PROTOBUF_NDEBUG_INLINE GetVarifyRsp::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
GetVarifyRsp::~GetVarifyRsp() {
  // @@protoc_insertion_point(destructor:GateServer.Varify.GetVarifyRsp)
  SharedDtor(*this);
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 0, 48, 2> GetVarifyRsp::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::GateServer::Varify::GetVarifyRsp>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
  ...
  {{
    "\36\0\5\4\0\0\0\0"
    "GateServer.Varify.GetVarifyRsp"
    "email"
    "code"
  }},
};
...
// @@protoc_insertion_point(message_clear_start:GateServer.Varify.GetVarifyRsp)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* GetVarifyRsp::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:GateServer.Varify.GetVarifyRsp)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_email().empty()) {
            const std::string& _s = this_._internal_email();
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "GateServer.Varify.GetVarifyRsp.email");
          ...
          if (!this_._internal_code().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "GateServer.Varify.GetVarifyRsp.code");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:GateServer.Varify.GetVarifyRsp)
          return target;
        }
        ...
        ::size_t GetVarifyRsp::ByteSizeLong() const {
          const GetVarifyRsp& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:GateServer.Varify.GetVarifyRsp)
          ::size_t total_size = 0;
...
void GetVarifyRsp::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:GateServer.Varify.GetVarifyRsp)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:GateServer.Varify.GetVarifyRsp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_GateServer_2eVarify_2eproto),
         ::std::false_type{});
