...
#ifndef GateServer_2eVarify_2eproto_2epb_2eh
#define GateServer_2eVarify_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_GateServer_2eVarify_2eproto
...
struct TableStruct_GateServer_2eVarify_2eproto {
...
/* @@protoc_insertion_point(class_definition:GateServer.Varify.GetVarifyRsp) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "GateServer.Varify.GetVarifyRsp"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:GateServer.Varify.GetVarifyRsp)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_GateServer_2eVarify_2eproto;
};
// -------------------------------------------------------------------

class GetVarifyReq final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:GateServer.Varify.GetVarifyReq) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "GateServer.Varify.GetVarifyReq"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:GateServer.Varify.GetVarifyReq)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
inline const std::string& GetVarifyReq::email() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:GateServer.Varify.GetVarifyReq.email)
...
inline PROTOBUF_ALWAYS_INLINE void GetVarifyReq::set_email(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:GateServer.Varify.GetVarifyReq.email)
}
inline std::string* GetVarifyReq::mutable_email() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:GateServer.Varify.GetVarifyReq.email)
  return _s;
}
...
inline std::string* GetVarifyReq::release_email() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:GateServer.Varify.GetVarifyReq.email)
...
inline void GetVarifyReq::set_allocated_email(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:GateServer.Varify.GetVarifyReq.email)
}
...
inline ::int32_t GetVarifyRsp::error() const {
  // @@protoc_insertion_point(field_get:GateServer.Varify.GetVarifyRsp.error)
  return _internal_error();
}
inline void GetVarifyRsp::set_error(::int32_t value) {
  _internal_set_error(value);
  // @@protoc_insertion_point(field_set:GateServer.Varify.GetVarifyRsp.error)
}
...
inline const std::string& GetVarifyRsp::email() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:GateServer.Varify.GetVarifyRsp.email)
  return _internal_email();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void GetVarifyRsp::set_email(Arg_&& arg,
  ...
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.email_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:GateServer.Varify.GetVarifyRsp.email)
}
inline std::string* GetVarifyRsp::mutable_email() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:GateServer.Varify.GetVarifyRsp.email)
  return _s;
}
...
inline std::string* GetVarifyRsp::release_email() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:GateServer.Varify.GetVarifyRsp.email)
  return _impl_.email_.Release();
}
inline void GetVarifyRsp::set_allocated_email(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:GateServer.Varify.GetVarifyRsp.email)
}
...
inline const std::string& GetVarifyRsp::code() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:GateServer.Varify.GetVarifyRsp.code)
...
inline PROTOBUF_ALWAYS_INLINE void GetVarifyRsp::set_code(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:GateServer.Varify.GetVarifyRsp.code)
}
inline std::string* GetVarifyRsp::mutable_code() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_code();
  // @@protoc_insertion_point(field_mutable:GateServer.Varify.GetVarifyRsp.code)
  return _s;
}
...
inline std::string* GetVarifyRsp::release_code() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:GateServer.Varify.GetVarifyRsp.code)
...
inline void GetVarifyRsp::set_allocated_code(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:GateServer.Varify.GetVarifyRsp.code)
}
...
#endif  // GateServer_2eVarify_2eproto_2epb_2eh
